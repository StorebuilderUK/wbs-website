...
heroImage: "ecommerce-website-redesign"
...
import heroImage from '../../assets/images/blog/ecommerce-website-redesign.jpg';

<BlogHeroImage src={heroImage} alt="Avoid These Mistakes When Redesigning Your eCommerce Site" />
...
Once you have a goal in mind, it's time to start planning the redesign. This will involve creating a project plan and setting realistic deadlines. I've already written a comprehensive guide to [managing your eCommerce project](https://www.webuildstores.co.uk/post/project-management-guide) and that's a good starting point if you have no idea what the redesign process involves.
